  ...
  <>
    <div className="profile-box">
        ...
        <div className="profile-inner-box2">
          ...
          <div className="pet-info-box"> 
          <div style={{color:"rgba(232, 58, 104, 0.817)"}}><FaHeart /></div>
          <div className="pet-bars">
            {/* status{props.data.status} */}
          <div className="pet-bars-inner" style={{width: `${affectionRef.current}%`}}></div></div>
          </div>
          <div className="pet-info-box"> 
          <div style={{color:"rgba(0, 65, 177, 0.947)"}}><GiDogBowl /></div>
          <div className="pet-bars">
            {/* hunger{props.data.hunger} */}
          <div className="pet-bars-inner" style={{width: `${hungerRef.current}%`}}></div>
          </div>
          </div> 
          <div className="pet-info-box"> 
          <div style={{color:"rgba(255, 175, 4, 0.916)"}}><GrMoney /></div>
          <div className="pet-bars"> {props.data.gold} 
