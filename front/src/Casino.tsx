...
import cat1 from "./cat-image/cat1.png";
import cat2 from "./cat-image/cat2.png";
import cat3 from "./cat-image/cat3.png";
import cat4 from "./cat-image/cat4.png";
import cat5 from "./cat-image/cat5.png";
import cat6 from "./cat-image/cat6.png";
import cat7 from "./cat-image/cat1.png";
...
class Casino extends React.Component {
  ...
  imageUrls: string[] = [cat1, cat2, cat3, cat4, cat5, cat6, cat7];
  componentDidMount() {
    this.initializeGame();
  }
        ...
        for (let i = 0; i < column.length; i++) {
          if (column[i].src.includes("blank")) {
            const randomIndex = Math.floor(
              Math.random() * this.imageUrls.length
            );
