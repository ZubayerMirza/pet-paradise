...
useEffect(()=>{
 ...
 <div className="header">
  <div className="header-box">
     {isLogin ===true ? 
     <div className="Logo"><img src={Logo} style={{height:"80px"}} alt="logo"></img></div> 
     : <div className="Logo"><img src={Logo} style={{height:"80px"}} alt="logo"></img></div> }
     </div>
    ...
    <div className="navi-innerbox"></div>
      ...
      <div className="navi-innerbox">
        <div className="navi-contents1"><p>Hello,   {props.data.petname}</p> </div>
      <div className="navi-contents" onClick ={onclickHandler} id="pet">Pet</div>
      <div className="navi-contents" onClick ={onclickHandler} id="item" >Item</div>
      <div className="navi-contents" onClick ={onclickHandler} id="friend" >Friend</div>
      <div className="navi-contents" onClick ={onclickHandler} id="chat" >chat</div>
      <div className="navi-contents" onClick ={onclickHandler} id="logout" >Logout</div>
      </div>
    </div>
 </div>
 ...
 <div className='body'>
  {/* sidebar */}
  {side.current ==="ChatSideBar" ? 
  (<ChatSideBox Click={Click} Change={Change}></ChatSideBox>) : (<LeftBox></LeftBox>)
  ||
  side.current==='SideBar'? <LeftBox></LeftBox>:<LeftBox></LeftBox>}
  
  {/* middlebox */}
  {/* currentChat -> make taking id of frineds */}
  {body.current ==="MiddleChat" ? 
  (<MiddleChat currentChat={currentChat} data={props.data} chatBox={chatBox} ChatBoxReset={ChatBoxReset}></MiddleChat>) : <MiddleBox ></MiddleBox>
  && body.current ==="friend" ? 
(<Friend data={props.data}></Friend>):(<MiddleBox data={props.data}></MiddleBox>)
}
